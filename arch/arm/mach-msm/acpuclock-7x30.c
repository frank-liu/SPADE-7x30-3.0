...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 1, 149760, PLL_3,    5, 2,  61440000,  825, VDD_RAW(825) },
	...
	{ 1, 1612800, PLL_2, 3, 0, 192000000, 1325, VDD_RAW(1325), &pll2_tbl[6]},
	{ 1, 1689600, PLL_2, 3, 0, 192000000, 1375, VDD_RAW(1375), &pll2_tbl[6]},
	{ 1, 1766400, PLL_2, 3, 0, 192000000, 1425, VDD_RAW(1425), &pll2_tbl[6]},
	{ 1, 1843200, PLL_2, 3, 0, 192000000, 1450, VDD_RAW(1450), &pll2_tbl[6]},
	{ 1, 1920000, PLL_2, 3, 0, 192000000, 1500, VDD_RAW(1500), &pll2_tbl[6]},
	{ 1, 1996800, PLL_2, 3, 0, 192000000, 1525, VDD_RAW(1525), &pll2_tbl[6]},
	{ 1, 2016000, PLL_2, 3, 0, 192000000, 1550, VDD_RAW(1550), &pll2_tbl[6]},
